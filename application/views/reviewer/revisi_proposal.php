                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="form-radio">
                                                                                <div class="radio radio-inline">
                                                                                    <label for="accept<?php echo $pr->id ?>">
                                                                                        <input id="accept<?php echo $pr->id ?>" type="radio" name="radio" value="WAITFUND">
                                                                                            <i class="helper"></i>Diterima
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio radio-inline">
                                                                                    <label for="revision<?php echo $pr->id ?>">
                                                                                        <input id="revision<?php echo $pr->id ?>" type="radio" name="radio" value="REVISION">
                                                                                            <i class="helper"></i>Revisi
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio radio-inline">
                                                                                    <label for="reject<?php echo $pr->id ?>">
                                                                                        <input id="reject<?php echo $pr->id ?>" type="radio" name="radio" value="REJECTED">
                                                                                            <i class="helper"></i>Ditolak
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="md-input-wrapper">
                                                                                <textarea id="budgetNotes" class="md-form-control md-static" cols="2" rows="4" name="rab" ></textarea>
