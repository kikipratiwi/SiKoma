                                                    ...
                                                    <div class="tab-pane active" id="proposal-document" role="tabpanel">
                                                        <!-- Proposal Document inputs starts -->
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" name="budget" type="text" id="currency-field" pattern="^\$\d{1,3}(.\d{3})*(\,\d+)?Rp" value="" data-type="currency" placeholder="Jumlah Dana" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
...
<script> 
    ...
    function addComponent(key, datum, index) {
        ...
        // mentor
        <?php foreach($mentor as $key => $mnt) : ?>
            optionText = <?php echo json_encode($mnt->name, JSON_HEX_TAG); ?>;
            optionValue = <?php echo json_encode($mnt->id, JSON_HEX_TAG); ?>;
